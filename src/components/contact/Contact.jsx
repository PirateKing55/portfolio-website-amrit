            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__card">
                        ...
                        <p className="contact__card-data">amritkp21@iitk.ac.in</p>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <p className="contact__card-data">+91 7810868165</p>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <a href='https://www.linkedin.com/in/amrit-kumar-975965266/' target='_blank' className="contact__card-data">Click here</a>
                    </div>
                </div>
